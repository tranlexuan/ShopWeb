...
for(int i = 1 ; i < 4; i++)
	{
		...
		List <WebElement> titles = driver.findElements(By.cssSelector("span[name='YouTube']"))
		actions.moveToElement(titles[1]).perform()
		titles[1].click()
		println('click được email lần thứ ' + i  )
		// tim btn xoa 
		WebElement btndel =  driver.findElement(By.cssSelector("div[class='T-I J-J5-Ji nX T-I-ax7 T-I-Js-Gs mA'][jslog='20283; u014N:cOuCgd,Kr2w4b']"))
